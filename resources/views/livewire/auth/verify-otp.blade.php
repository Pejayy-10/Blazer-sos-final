        ...
        <div class="w-full max-w-4xl flex flex-col md:flex-row overflow-hidden rounded-2xl shadow-2xl transform hover:scale-[1.01] transition-all duration-500">
            ...
            <div class="w-full md:w-1/2 glass-dark p-8 md:p-12 animate-fade-in-up">
                ...
                <div class="mb-6 flex flex-col items-center md:items-start">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-bold mb-2 tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-[#D4B79F]">Verify Your Email</h1>
                ...
                <div class="mt-8 text-sm text-white/70 space-y-2 relative z-10">
                    <p>
                        Already verified? <a href="{{ route('login') }}" class="text-[#D4B79F] hover:text-white transition-colors duration-200 hover:underline" wire:navigate>Login here</a>
                    </p>
                    <p>
            ...
            <div class="hidden md:block md:w-1/2 relative overflow-hidden">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center p-8 lg:p-16 text-center z-20">
                    <h2 class="text-3xl lg:text-4xl font-bold text-white mb-6 animate-fade-in-up">Secure Your Yearbook Experience</h2>
                    <p class="text-white/70 max-w-xl mb-8 animate-fade-in-up animate-delay-300">
                        We use email verification to ensure your account security. This helps us protect your information and provide you with a safe platform to preserve your college memories.
                    </p>
                        ...
                        <div class="relative z-10 glass-dark rounded-lg p-8 border border-white/10 shadow-2xl transform rotate-3 hover:rotate-0 transition-all duration-500">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-full bg-[#D4B79F] flex items-center justify-center text-[#5F0104] font-bold">JD</div>
                                    <div class="ml-3">
                                        <div class="font-medium">John Doe</div>
                                        <div class="text-xs text-white/50">Computer Science, 2024</div>
                                    </div>
                                </div>
                                <div class="text-[#D4B79F]">Verified</div>
                            </div>
                            <div class="h-32 bg-gradient-to-r from-[#5F0104] to-[#7A1518] rounded mb-4 flex items-center justify-center">
                                <span class="text-white/80">Yearbook Photo</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="text-sm">Added: June 2, 2023</div>
